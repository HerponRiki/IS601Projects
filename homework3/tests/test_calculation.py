...
@pytest.mark.parametrize("_a, _b, operation, expected", [
...
def test_calculation_operations(_a, _b, operation, expected):
    """
    Test calculation operations with various scenarios.
    """
    calc = Calculation(_a, _b, operation)  # Create a Calculation instance with the provided operands and operation.
    assert calc.perform() == expected, f"Failed {operation.__name__} operation with {_a} and {_b}"  # Perform the operation and assert that the result matches the expected value.
