...
# Import Calculation and Calculations classes from the calculator directory
from calculator.calculation import Calculation
from calculator.calculations import Calculations

# Import add and subtracct
...
def test_add_calculation(setup_calculations):
    ...
    # if the latest calculation in the history matches
    assert Calculations.get_latest() == calc, "ERROR: Failed to add the calculation to the history"
...
def test_get_history(setup_calculations):
    ...
    assert len(history) == 2, "ERROR: History does not contain the expected number of calculations"
