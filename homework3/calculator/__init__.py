...
class Calculator:
    @staticmethod
    def _perform_operation(_a: Decimal, _b: Decimal, operation: Callable[[Decimal, Decimal], Decimal]) -> Decimal:
        """Create and perform a calculation, then return the result."""
        # Create a Calculation object using the static create method, passing in operands and the operation
        calculation = Calculation.create(_a, _b, operation)
    ...
    def add(_a: Decimal, _b: Decimal) -> Decimal:
        ...
        return Calculator._perform_operation(_a, _b, add)
    ...
    def subtract(_a: Decimal, _b: Decimal) -> Decimal:
        ...
        return Calculator._perform_operation(_a, _b, subtract)
    ...
    def multiply(_a: Decimal, _b: Decimal) -> Decimal:
        ...
        return Calculator._perform_operation(_a, _b, multiply)
    ...
    def divide(_a: Decimal, _b: Decimal) -> Decimal:
        ...
        return Calculator._perform_operation(_a, _b, divide)